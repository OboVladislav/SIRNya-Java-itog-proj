# Автоматический тест канала EMAIL.
# Поднимает фейковый SMTP-эмулятор с захватом вывода, регистрирует пользователя,
# генерирует OTP-код по каналу EMAIL, проверяет что код реально дошёл до эмулятора,
...
# email.properties уже настроен на localhost:2525 (без авторизации).
param(
